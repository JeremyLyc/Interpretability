...
python generate_ground_truth_graph_classification.py --dataset=ours --output=ours --graph-mode --top_k=10
python generate_ground_truth_graph_classification.py --dataset=ours --output=ours --graph-mode --top_k=20
```
...
python explainer_gae_graph.py --distillation=ours_top10 --output=ours_top10 --dataset=ours --gpu -b 128 --weighted --gae3 --loss=mse --early_stop --graph_labeling --train_on_positive_label --epochs=300 --lr=0.01
python explainer_gae_graph.py --distillation=ours_top20 --output=ours_top20 --dataset=ours --gpu -b 128 --weighted --gae3 --loss=mse --early_stop --graph_labeling --train_on_positive_label --epochs=300 --lr=0.01
```
...
python test_explained_adj_graph.py --graph-mode --dataset=ours --exp_out=ours_top10 --distillation=ours_top10 --top_k=5 --test_out=ours_top10_top5
python test_explained_adj_graph.py --graph-mode --dataset=ours --exp_out=ours_top20 --distillation=ours_top20 --top_k=15 --test_out=ours_top20_top15
```
